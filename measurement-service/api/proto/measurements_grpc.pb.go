...
const (
	MeasurementService_GetMeasurements_FullMethodName = "/measurements.v1.MeasurementService/GetMeasurements"
)
...
func (c *measurementServiceClient) GetMeasurements(ctx context.Context, in *GetMeasurementsRequest, opts ...grpc.CallOption) (*GetMeasurementsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetMeasurementsResponse)
	err := c.cc.Invoke(ctx, MeasurementService_GetMeasurements_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMeasurementServiceServer) GetMeasurements(context.Context, *GetMeasurementsRequest) (*GetMeasurementsResponse, error) {
...
func _MeasurementService_GetMeasurements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMeasurementsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MeasurementServiceServer).GetMeasurements(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MeasurementService_GetMeasurements_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MeasurementServiceServer).GetMeasurements(ctx, req.(*GetMeasurementsRequest))
	}
...
var MeasurementService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "measurements.v1.MeasurementService",
	...
	Metadata: "api/proto/measurements.proto",
}
